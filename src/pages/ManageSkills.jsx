...
const ManageSkills = () => {
  ...
  return <>
    <div className="w-full flex min-h-screen flex-col bg-muted/40">
    <Tabs defaultValue="week">
      <TabsContent value="week">
        <Card>
        <CardHeader className="flex gap-4 sm:justify-between sm:flex-row sm:items-center">
              <CardTitle>Manage Your Skills</CardTitle>
              <Link to={"/"}> <Button className="w-fit">
                Return to Dashboard
              </Button></Link>
            </CardHeader>
            <CardContent className="grid sm:grid-cols-2 gap-4">
              {
                ...
                ) : <CardTitle className="overflow-hidden text-3xl">You have not added any skill</CardTitle>
              }
            </CardContent>
        </Card>
      </TabsContent>
