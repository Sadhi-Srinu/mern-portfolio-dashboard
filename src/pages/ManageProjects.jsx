...
const ManageProjects = () => {
  const {error, loading, projects, message} = useSelector(state => state.project); // project is coming from projectSlice.js
                          ...
                          <TableRow className="bg-accent" key={element._id}>
                            <TableCell>
                              <div className="font-medium">
                                <img src={element.projectBanner && element.projectBanner.url} alt={element.title} className="w-36 h-36" />
                              </div>
                            </TableCell>
                            <TableCell>
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Link to={`/view/project/${element._id}`}>
                                      <button className="border-green-600 border-2 rounded-full h-8 w-8 flex justify-center items-center text-green-600  hover:text-slate-950 
                                      hover:bg-green-600">
