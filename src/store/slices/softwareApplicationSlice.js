...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://mern-portfolio-backend-vilj.onrender.com/api/v1/softwareapplication/add",
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://mern-portfolio-backend-vilj.onrender.com/api/v1/softwareapplication/delete/${id}`,
      { withCredentials: true, }
    );
    dispatch(
